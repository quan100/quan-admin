 ...
 * @param fields
 */
const handleUpdate = async (fields: API.Article) => {
...
const Role: React.FC = () => {
  ...
  const columns: ProColumns<API.Article>[] = [
    ...
    {
      title: (<FormattedMessage id="pages.article.articleId"/>),
      dataIndex: 'articleId',
    },
    {
    ...
    {
      title: <FormattedMessage id="pages.article.author"/>,
      dataIndex: 'author',
    },
    {
    ...
    {
      title: (<FormattedMessage id="pages.article.sort"/>),
      dataIndex: 'sort',
      search: false
    },
    {
      title: (<FormattedMessage id="pages.article.updateTime"/>),
  ...
  return (
    <PageContainer>
      <ProTable<API.Article, API.ArticleQuery>
