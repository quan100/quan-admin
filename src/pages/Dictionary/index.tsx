 ...
 * @param fields
 */
const handleAdd = async (fields: API.Dictionary) => {
 ...
 * @param fields
 */
const handleUpdate = async (fields: API.Dictionary) => {
 ...
 * @param selectedRows
 */
const handleRemove = async (selectedRows: API.Dictionary[]) => {
...
const Role: React.FC = () => {
  ...
  const columns: ProColumns<API.Dictionary>[] = [
    {
    ...
    },
    {
      ...
      valueEnum: {
        ...
        1: {
          text: (
            <FormattedMessage id="pages.dictionary.open.on"/>
          ),
          color: 'red',
        },
      },
  ...
  return (
    <PageContainer>
      <ProTable<API.Dictionary, API.DictionaryQuery>
      ...
      <SaveForm
        ...
        onSubmit={async (value) => {
          const success = await handleAdd(value as API.Dictionary);
          if (success) {
