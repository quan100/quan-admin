 ...
 * @param fields
 */
const handleAdd = async (fields: API.Friendly) => {
 ...
 * @param fields
 */
const handleUpdate = async (fields: API.Friendly) => {
 ...
 * @param selectedRows
 */
const handleRemove = async (selectedRows: API.Friendly[]) => {
...
const Role: React.FC = () => {
  ...
  const [currentRow, setCurrentRow] = useState<API.Friendly>();
  ...
  const columns: ProColumns<API.Friendly>[] = [
    {
  ...
  return (
    <PageContainer>
      <ProTable<API.FriendlyQuery, API.Friendly>
      ...
      <SaveForm
        ...
        onSubmit={async (value) => {
          const success = await handleAdd(value as API.Friendly);
          if (success) {
